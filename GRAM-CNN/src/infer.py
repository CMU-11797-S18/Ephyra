...
optparser.add_option(
    "-T", "--train", default="../dataset/NLPBA/train/train.eng",
    help="Train set location"
)
optparser.add_option(
    "-d", "--dev", default="../dataset/NLPBA/train/dev.eng",
...
optparser.add_option(
    "-p", "--pre_emb", default="../embeddings/bio_nlp_vec/PubMed-shuffle-win-30.bin",
...
optparser.add_option(
    "-H", "--hidden_layer", default = "12",
    type = 'int', help = "number of layers used in LSTM"
)
optparser.add_option(
    "-K", "--kernel_size", default = "2,3,4",
    type  = 'string', action='callback',
    callback=get_comma_separated_args
)
optparser.add_option(
    "-k", "--kernel_num", default = "40,40,40",
    type  = 'string', action='callback',
    callback=get_comma_separated_args
)
optparser.add_option(
...
# model_name = "use_wordTrue use_charTrue drop_out0.5 hidden_size75 hidden_layer10 lowerTrue allembFalse kernels2, 3, 4 num_kernels40, 40, 40 paddingTrue ptsTrue w_emb200"
model_name = "use_wordTrue use_charTrue drop_out0.5 hidden_size675 hidden_layer12 lowerTrue allembFalse kernels2, 3, 4 num_kernels40, 40, 40 paddingTrue ptsTrue w_emb200"
